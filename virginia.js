function criarBarra(var_nome = 'Seu Nome', var_avatar = '', var_insta_nome = 'seunome', var_insta_url = 'https://instagram.com', var_seguidores = '1,2 mil', var_publi = '132') {
  ...
  .typebot-input-container {
    ...
    right: 10px;
    z-index: 999;
    width: calc(100% - 20px); /* Adapta a largura ao tamanho da tela */
  }
  ...
  .typebot-input-form .typebot-button {
    ...
    padding: 10px;
    text-align: center;
    width: 100%; /* Mesma largura das mensagens */
    box-sizing: border-box;
    font-size: 16px;
    cursor: pointer;
  }
  
  .typebot-input-form .typebot-button:hover {
    background-color: #003f99;
  }
  
  .typebot-input-form .typebot-button:focus {
    outline: none;
    box-shadow: 0 0 4px rgba(0, 92, 197, 0.8);
  }
